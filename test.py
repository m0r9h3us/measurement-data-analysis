...
path = "/home/morpheus/Projects/Hotwire/Test_Data/"
...
# c = Timeseries_1D(np.arange(10), x=np.arange(10), caption=caption, sampling_frequency=20000)
# d= Timeseries_1D_Periodic_Signal(np.arange(10), x=np.arange(10), caption=caption, sampling_frequency=20000).plot()
